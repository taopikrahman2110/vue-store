            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="product-pic-zoom">
                  <img class="product-big-img" :src="imageUrl" alt="" />
                </div>
                <div class="product-thumbs">
                  <carousel :nav="false" :dots="false"  class="product-thumbs-track ps-slider">
                    <div class="pt" @click="changeImage(thumbs[0])" :class="thumbs[0] == imageUrl ? 'active' : ''">
                      <img src="img/mickey1.jpg" alt="" />
                    </div>

                    <div class="pt" active @click="changeImage(thumbs[1])" :class="thumbs[1] == imageUrl ? 'active' : ''">
                      <img src="img/mickey2.jpg" alt="" />
                    </div>

                    <div class="pt" @click="changeImage(thumbs[2])" :class="thumbs[2] == imageUrl ? 'active' : ''">
                      <img src="img/mickey3.jpg" alt="" />
                    </div>

                    <div class="pt" @click="changeImage(thumbs[3])" :class="thumbs[3] == imageUrl ? 'active' : ''">
              ...
              <div class="col-lg-6">
                <div class="product-details">
                  ...
                  <div class="pd-desc" style="text-align: justify;">
                    <p>
                  ...
                  <div class="quantity">
                    <router-link to="/shopping"><a href="#" class="primary-btn pd-cart"
